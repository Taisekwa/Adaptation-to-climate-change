df<-read.csv("C:/Users/chikazhet/deep_south.csv")
...
ggplot()+        
  geom_point(data=deep_south, mapping=aes(y = pgr, x = month, colour=option)) +
...
ggplot()+
geom_point(data=temp0, mapping=aes(y = pgr, x = month, colour=option))+
  scale_x_discrete(limits = c("Jun", "Jul", "Aug","Sep", "Oct", "Nov","Dec", "Jan", "Feb","Mar", "Apr", "May"))
...
ggplot()+
  geom_point(data=temp4, mapping=aes(y = pgr, x = month, colour=option))+
  scale_x_discrete(limits = c("Jun", "Jul", "Aug","Sep", "Oct", "Nov","Dec", "Jan", "Feb","Mar", "Apr", "May"))
